...
void Menu::add_menu_item(const string menu_name, double meat, double chicken, double tomato, double potato, double cheese) {
    string sql = "INSERT INTO MENU (MENU_NAME, MEAT, CHICKEN, TOMATO, POTATO, CHEESE) VALUES ('" +
                 menu_name + "', " + to_string(meat) + ", " + to_string(chicken) + ", " +
                 to_string(tomato) + ", " + to_string(potato) + ", " + to_string(cheese) + ");";
